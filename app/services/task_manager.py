...
class TaskManager:
    def __init__(self,task_executor):
        ...
        logger.info("[TASK-MGR] Backfround task manager initialized (4 workers)")
    ...
    def _run(self,task_id:str,intent_type:str,payload:dict,chat_history):
        ...
        try:
            ...
            logger.info("[TAKS-MGR] Task %s compaeted in %.2fs",task_id,elapsed)
            ...
            logger.warning("[TAKS-MGR] Task %s failed: %s",task_id,e)
