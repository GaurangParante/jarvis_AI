...
from app.services.decision_types import (
    CATEGORY_GENERAL, CATEGORY_REALTIME, CATEGORY_CAMERA, CATEGORY_TASK, CATEGORY_MIXED,
...
CAMERA_BYPASS_TOKEN = "TTCAMTOKENT"
        ...
        try:
            for chunk in self.groq_service.stream_response(
                ...
                if isinstance(chunk, dict):
                    ...
                    continue
                if chunk_count == 0:
                    elapsed_ms = int((time.perf_counter() - 0) * 1000)
        ...
        if category in (CATEGORY_TASK, CATEGORY_MIXED):
            ...
            if self.task_manager and heavy_intents:
                ...
                if sync_response.images or sync_response.contents:
                    ...
                    yield {"_actions": actions}
                instant_response.text = instant_response.text or sync_response.text or sync_response.text
